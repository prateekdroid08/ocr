...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback,
    ...
    void onShutterButtonPressContinuous() {
        ...
        if (lastResult != null) {
            ...
            Toast toast = Toast.makeText(this, "Scan failed. Please try again.", Toast.LENGTH_SHORT);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            ...
            if (event.getRepeatCount() == 0) {
                cameraManager.requestAutoFocus(0L);
            }
            return true;
        }
...
//            }
     ...
     */
    void showLanguageName() { // Show language to scanned
//        Toast toast = Toast.makeText(this, sourceLanguageReadable, Toast.LENGTH_LONG);
//        toast.setGravity(Gravity.TOP, 0, 0);
//        toast.show();
    }
    ...
    void displayProgressDialog() {
        ...
        String ocrEngineModeName = getOcrEngineModeName();
        if (ocrEngineModeName.equals("Both")) {
            indeterminateDialog.setMessage("Scaning document...");
        } else {
            indeterminateDialog.setMessage("Scaning document...");
        }
        indeterminateDialog.setCancelable(false);
